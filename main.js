...
function addCards (num) {
  ...
  for(let i = 0; i < classArrLength; i++){
    ...
    document.getElementsByClassName('gameField')[0].append(createHtml('div', `card ${classArray[random]}`));
